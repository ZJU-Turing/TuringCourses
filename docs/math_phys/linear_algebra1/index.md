...
=== "吴志祥"
    ...
    吴志祥老师（被大家亲切地称呼为吴爷爷）是研究代数的教授，因此对于代数的理解相当之深。老师上课不完全按照教材讲解顺序推进，在很多地方有相较于教材更漂亮的处理，并且例子信手拈来，也都是相当经典，如果仔细体会能感受到老师深厚的功力。但吴志祥老师上课有一点点快，一致连续，非常连贯（简而言之捡一支笔可能就不知道在干什么了），并且口音比较重（但是上他的课时间长了也就没有这方面的障碍了），有时候难以跟上，但是做好预习或者课后重新看智云课堂都可以体会到老师的教学与学术功力，非常适合建立体系。除此之外，吴志祥老师捞人功力十分深厚，能从马里亚纳海沟捞到你（×），是出了名的“毫无道德”。  
...
=== "冯涛"
    ...
    冯涛老师讲课侧重基础算法，会跳过过于技术性的部分（例如惯性定理的证明）和抽象化的部分（例如线性空间的八条公理）。另外因为面向工科生，上课难度较低，因此期末考前可以提前一段时间check一下历年卷的风格和难度。平时工作量比较小，可能要补充部分课后题训练应试技巧（老师也鼓励大家做课后题）。根据自身体验给分是好的。老师的板书比较完善，如果复习板书不必担心遗漏。
...
LALU 开源仓库：[:material-github: yhwu-is/Linear-Algebra-Left-Undone](https://github.com/yhwu-is/Linear-Algebra-Left-Undone)

!!! note "关于利用 LALU 进行辅助学习"
    由于 LALU 对证明的追求比较细致，书的整体节奏是相对较慢的，因此比较适合同学们平时结合课堂内容加深理解。也因此，**不建议**同学们在期末周补天的时候以通读 LALU 补全体系作为复习手段（除非你有大把的时间投入到线性代数的复习中）。可以根据下面的学习建议明确自己的定位，如果你的目标是第 0 级或者对绩点没有很高的追求（比如上 4），那我认为你还是把主要精力放在掌握计算题以及一些课后习题中的简单证明题性价比会更高。
