...
=== "吴志祥"
    ...
    吴志祥老师讲课清晰给分好（建议熟悉一下吴志祥老师的口音，听习惯了问题不大）。22 级是吴志祥老师第一次教 done right 的线代二。wzx 课上会讲解 done right 上的证明和例题，思路清晰，每周布置几道 done right 的课后题（网上有答案，但是不够全（参考 https://linearalgebras.com）。wzx 很少签到，印象中签了一次还是数字签到。
    ...
    22 级期末是 wzx 和 lks 一起出题，lks 会在最后一节习题课讲解和考题很相似的题目，因此墙裂建议去听 lks 最后的一节习题课。
