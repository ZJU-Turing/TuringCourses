...
=== "吴志祥"
    ...
    吴志祥老师讲课清晰给分好（建议熟悉一下吴志祥老师的口音，听习惯了问题不大）。22级线代2是使用《Linear Algebra Done Right》（这是吴志祥老师第一次教done right的线代2），21级是使用吴志祥老师自己编写的《Algebra》。
    wzx课上会讲解done right上的证明和例题，思路清晰，每周布置几道done right的课后题（网上有答案，但是不够全https://linearalgebras.com
    wzx很少签到，印象中签了一次还是数字签到。

    习题课：
    （如果还是同一位助教的话）助教的习题课和老师上课讲的感觉是两套体系（雾，听起来可能有些吃力，我反正是去拿作业，也坚持听完了hhh，课后有什么问题提问可以得到很好的答复。
    期中是助教出题（老师可能会暗示助教出难一点，所以考出来成绩可能比较低，不过期中占比可能不大）期中是在习题课上考而且会延时到下节课，所以尽量不要在习题课的下一节课选身体素质课
    
    课外：
    给分方面很捞，但也要认真学，done right难度还是挺高的。推荐上wyy的辅学课！！！
    另外b站上有讲解done right的视频，也可以作为一种补充。
    b站3b1b的 线性代数的本质 也非常推荐，帮助可视化理解线性代数。

    期末：
    22级期末是wzx和lks一起出题（lks会在最后一节习题课讲解和考题很相似的题目，因此墙裂建议去听lks最后的一节习题课）
...
- [（22 级）2023 春夏wzx班期中历年卷](线性代数 Ⅱ（H）2023春夏wzx班期中历年卷.pdf) | [解答](线性代数 Ⅱ（H）2023春夏wzx班期中历年卷助教答案.pdf)
