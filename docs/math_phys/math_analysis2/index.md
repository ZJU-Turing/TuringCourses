...
=== "姜海益"
    ...
    授课、给分等情况待补充（可参考[数学分析（甲）I（H）](../math_analysis1/index.md#任课教师)的内容）
...
如果你对分析比较感兴趣，或者说想在之后的学习中想要熟练地运用分析方面的知识，而不是用到就忘，那么或许你个人应该去构建这门课程的体系，将知识点串联起来，并且配合一些其他的书籍，可以参考[数学分析（甲）I（H）](../math_analysis1/index.md#第-2-级想要-48-的绩点满绩可遇不可求)中的建议。这个过程不要太注重计算技巧等细枝末节。