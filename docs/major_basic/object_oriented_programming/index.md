...
=== "许威威"
    ...
    分数构成：期末考试 50%，平时 50% 包括 6 个小实验和 1 个大作业（~~实际上也不大~~）

    平时作业：在pta上布置的题目，由人工批改，因此对题目中说的要求一定要认真阅读。另外许威威似乎不是很喜欢发书面的通知，24春夏的几次作业ddl都是课上口头通知，直到期末考结束才说明迟交penalty。

    大作业：allocator & memory pool，给分规则（ 100 分制）：功能完成，测试程序通过，得到基础评分 88 分。剩下 12 分按速度排名给分：前1/3得到12分，后2/3按排名线性分配12~0分，四舍五入。

    期末考试：课程组统一的期末考试。<!-- 期末主观题的给分还挺好 -->

    考勤：~~许威威似乎只会拿名单点名~~，在24春夏上课时由于人数过多实际上没有进行点名。

    总结：大许老师的讲课真的很一般，感觉基本没有人在听，建议转向wk或cx的智云课堂。相比于这两个班的好处是平时作业少，没有wk老师的期中考和繁杂的平时作业。对于平时分主要的雷点在于通知不到位，基本都是课堂上的口头通知以及最后才出来的penalty政策。单就给分而言，24春夏助教对平时分还是比较慷慨的，只有在代码不规范以及边界情况不正确时才会获得(-1)的扣分。
