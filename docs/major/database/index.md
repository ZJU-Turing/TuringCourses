...
期末方面，数据库卷子从 2022 年春夏开始改革，不再是以前的“八股文”，2022 年添加了选择题，2023 年添加了判断题，2024 年删除了判断题，所有的选择题都改成了不定项选择，最后还出现了 none or all or some of above 的选项。因为期末的原因，24 年的期末占比改为了 40%，具体的平时分不详，但认真完成实验的、通过验收的助教基本都把平时分给满了（期末试卷相当恶心）<s>但改革后的回忆卷仍然值得参考。</s>需要注意的是不同老师的讲课内容有所出入，可以综合几个老师的讲课内容，确定考试范围。抄 CheatingSheet 的过程本身就是一个复习的过程，抄完之后内容其实就已经差不多清晰了。
